...
func (e TradeClient) FromAdmin(msg *quickfix.Message, sessionID quickfix.SessionID) (reject quickfix.MessageRejectError) {
	fmt.Println(`ToAdmin msg------()()()()()------> `, msg.String())
	return nil
}

// ToAdmin implemented as part of Application interface
func (e TradeClient) ToAdmin(msg *quickfix.Message, sessionID quickfix.SessionID) {
	if msgType, err := msg.Header.GetString(tag.MsgType); err == nil && msgType == "A" {
		fmt.Println(`FromAdmin msg------*********------> `, msg.String())
		msg.Body.SetField(tag.Username, quickfix.FIXString("Amstel"))
		msg.Body.SetField(tag.Password, quickfix.FIXString("BondbloX"))
	}
}
...
func (e TradeClient) FromApp(msg *quickfix.Message, sessionID quickfix.SessionID) (reject quickfix.MessageRejectError) {
	utils.PrintInfo(fmt.Sprintf("FromApp: %q", msg.String()))
	return
}
...
func execute(cmd *cobra.Command, args []string) error {
	...
	fmt.Println(`cfgFileName---------------->`, cfgFileName)
...
Loop:
	for {
		...
		case "2":
			err = internal.QuerySecurityListRequest()
		case "5":
			//quit
			break Loop
